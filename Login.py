...
def main_screen():
    ...
    subtitle = Label(frame1, text='Welcome to Student Management System', font=("Gudy old style", 14, "bold"), fg='red', bg="#33272a")
    ...
    Label(text="", bg='white').pack()
    Label(text="", bg='white').pack()
    Button(frame1,text="LOGIN", height="3", width="30", font=("CALBRIA", 14, "bold"),fg="black", command=login).place(x=20,y=200)
    Label(text="",bg='white').pack()
    Button(frame1,text="REGISTER", height="3", width="30", font=("CALBRIA", 14, "bold"), fg="black",  command=register).place(x=20, y=350)
